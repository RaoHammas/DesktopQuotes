    ...
    public partial class QuoteWindow : Window, INotifyPropertyChanged
    {
        ...
        private void ReadSettings()
        {
            ...
            finally
            {
                if (QuoteSettings != null)
                {
                    _timer.Interval = QuoteSettings.QuoteTime;
        ...
        private void OpenSettings_Click(object sender, MouseButtonEventArgs e)
        {
            try
            {
                ...
                _settingsWindow.CheckBoxShadowEnable.Click += CheckBoxShadowEnableOnChecked;
        ...
        private void CheckBoxShadowEnableOnChecked(object sender, RoutedEventArgs e)
        {
            if (sender is CheckBox checkBox)
            {
                QuoteSettings.DropShadow = (bool)checkBox.IsChecked!;
                OnPropertyChanged(nameof(QuoteSettings));
            }
        }
        ...
        private void ButtonSaveOnClick(object sender, RoutedEventArgs e)
        {
            try
            {
                ...
                using var file = File.CreateText(@"Settings.json");
                var serializer = new JsonSerializer();
        ...
        private void ButtonColorPickerOnClick(object sender, RoutedEventArgs e)
        {
            try
            {
                var ok = ColorPickerWindow.ShowDialog(out var color, ColorPickerDialogOptions.SimpleView);
                if (ok)
                {
